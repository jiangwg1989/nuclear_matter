...
l_e3max16      = plt.plot(x_list_e3max16,y_list_e3max16,color='k', linestyle = '-.',linewidth=1,marker='o', markersize=5,zorder=3,label='Expt.')
l_e3max14      = plt.plot(x_list_e3max14,y_list_e3max14,color='g', linestyle = '--',linewidth=1,marker='D', markersize=5,alpha=0.7,zorder = 1 ,label=r'$\Delta$NNLO$_{\rm{GO}}$(450)')
l_e3max12      = plt.plot(x_list_e3max12,y_list_e3max12,color='b', linestyle = ':' ,linewidth=1,marker='D', markersize=5,alpha=0.7,zorder = 2 ,label=r'$\Delta$NNLO$_{\rm{GO}}$(394)')
