...
l2 = plt.plot(x_list_2,y_list_2,color = 'b',linestyle='-.',linewidth=3,alpha=0.7,  label='DNNLO(450)$_{new}$')
...
l_saturation = plt.scatter(x_list_5_p,y_list_5_p,color = 'b',s=60, marker = 'D',linewidths=3)

#l3 = plt.plot(x_list_3,y_list_3,color = 'b',linestyle='--',label='A=28')
l4 = plt.plot(x_list_4,y_list_4,color = 'b',linestyle='-.',label='DNNLO(450)$_{new}$',linewidth=3,alpha=0.7)
...
rect = plt.Rectangle((0.15,-16.5), 0.02, 1, fill=False, edgecolor = 'red',linewidth=1)
