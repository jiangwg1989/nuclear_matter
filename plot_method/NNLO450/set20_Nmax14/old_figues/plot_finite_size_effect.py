...
plt.subplot(122)
l1 = plt.plot(x_list_1,y_list_1,color = 'b',linewidth=2,linestyle='--',label='N=14')
l2 = plt.plot(x_list_2,y_list_2,color = 'g',linewidth=2,linestyle='--',label='N=66')
l11 = plt.scatter(x_list_1_p,y_list_1_p,color = 'k', marker = 'o')
l22 = plt.scatter(x_list_2_p,y_list_2_p,color = 'k', marker = 'o')

#plt.title('Finite size effect')
...
plt.subplot(121)
l3 = plt.plot(x_list_3,y_list_3,color = 'b',linewidth=2,linestyle='--',label='A=28')
l4 = plt.plot(x_list_4,y_list_4,color = 'g',linewidth=2,linestyle='--',label='A=132')
l33 = plt.scatter(x_list_3_p,y_list_3_p,color = 'k', marker = 'o')
l44 = plt.scatter(x_list_4_p,y_list_4_p,color = 'k', marker = 'o')
