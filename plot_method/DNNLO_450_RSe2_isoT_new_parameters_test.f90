...
subroutine chp_preset_DNNLO_450_RSe2_isoT_new
    ...
    call chp_set_CIB_LO_contact(1, -1, -0.33911088D+00 ) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1, -0.25395016D+00 ) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0, -0.34011385D+00 ) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0, -0.25395016D+00 ) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1, -0.33988713D+00 ) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1, -0.25395016D+00 ) ! Ct_3S1nn

    ! NLO contacts
    call chp_set_chiral_C(1) ! Use
    call chp_set_NLO_contact(1, 2.52663619D+00 ) ! C_1S0
    call chp_set_NLO_contact(2, 0.67190823D+00 ) ! C_3P0
    call chp_set_NLO_contact(3, -0.21949786D+00 ) ! C_1P1
    call chp_set_NLO_contact(4, -0.91539782D+00 ) ! C_3P1
    call chp_set_NLO_contact(5, 0.96498950D+00 ) ! C_3S1
    call chp_set_NLO_contact(6, 0.44574306D+00 ) ! C_3S1-3D1
    call chp_set_NLO_contact(7, -0.89540466D+00 ) ! C_3P2
