subroutine chp_preset_DNNLO_394n4_RSe2
    ...
    call chp_set_Lambda(3.94000000000000000D+02)
    call chp_set_contact_format("PW")
    ! SET INCLUDED DIAGRAMS / TERMS

    ! LO contacts
    call chp_set_chiral_Ct_CIB(1) ! Use CIB contacts
    call chp_set_CIB_LO_contact(1, -1, -0.33750927D+00 ) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1, -0.25668592D+00 ) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0, -0.33837131D+00 ) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0, -0.25668592D+00 ) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1, -0.33812426D+00 ) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1, -0.25668592D+00 ) ! Ct_3S1nn

    ! NLO contacts
    call chp_set_chiral_C(1) ! Use
    call chp_set_NLO_contact(1, 2.48371701D+00 ) ! C_1S0
    call chp_set_NLO_contact(2, 0.69006970D+00 ) ! C_3P0
    call chp_set_NLO_contact(3, -0.57123244D+00 ) ! C_1P1
    call chp_set_NLO_contact(4, -1.00820670D+00 ) ! C_3P1
    call chp_set_NLO_contact(5, 0.94023109D+00 ) ! C_3S1
    call chp_set_NLO_contact(6, 0.46560225D+00 ) ! C_3S1-3D1
    call chp_set_NLO_contact(7, -0.87019184D+00 ) ! C_3P2
    ...
    call chp_set_2PE_reg_par(4.0D0)
    call chp_set_LO_contact_reg_par(1, 4.0D0) ! Ct_1S0
    call chp_set_LO_contact_reg_par(2, 4.0D0) ! Ct_3S1
    call chp_set_NLO_contact_reg_par(1, 4.0D0) ! C_1S0
    call chp_set_NLO_contact_reg_par(2, 4.0D0) ! C_3P0
    call chp_set_NLO_contact_reg_par(3, 4.0D0) ! C_1P1
    call chp_set_NLO_contact_reg_par(4, 4.0D0) ! C_3P1
    call chp_set_NLO_contact_reg_par(5, 4.0D0) ! C_3S1
    call chp_set_NLO_contact_reg_par(6, 4.0D0) ! C_3S1-3D1
    call chp_set_NLO_contact_reg_par(7, 4.0D0) ! C_3P2
    call chp_set_N3LO_contact_reg_par(1, 4.0D0) ! Dh_1S0
    call chp_set_N3LO_contact_reg_par(2, 4.0D0) ! D_1S0
    call chp_set_N3LO_contact_reg_par(3, 4.0D0) ! D_3P0
    call chp_set_N3LO_contact_reg_par(4, 4.0D0) ! D_1P1
    call chp_set_N3LO_contact_reg_par(5, 4.0D0) ! D_3P1
    call chp_set_N3LO_contact_reg_par(6, 4.0D0) ! Dh_3S1
    call chp_set_N3LO_contact_reg_par(7, 4.0D0) ! D_3S1
    call chp_set_N3LO_contact_reg_par(8, 4.0D0) ! D_3D1
    call chp_set_N3LO_contact_reg_par(9, 4.0D0) ! Dh_3S1-3D1
    call chp_set_N3LO_contact_reg_par(10, 4.0D0) ! D_3S1-3D1
    call chp_set_N3LO_contact_reg_par(11, 4.0D0) ! D_1D2
    call chp_set_N3LO_contact_reg_par(12, 4.0D0) ! D_3D2
    call chp_set_N3LO_contact_reg_par(13, 4.0D0) ! D_3P2
    call chp_set_N3LO_contact_reg_par(14, 4.0D0) ! D_3P2-3F2
    call chp_set_N3LO_contact_reg_par(15, 4.0D0) ! D_3D3
