...
subroutine chp_preset_DNNLO_450_RSe2_isoT
    ...
    call chp_set_CIB_LO_contact(1, -1, -0.33780455 ) ! Ct_1S0pp
    call chp_set_CIB_LO_contact(2, -1, -0.26456205 ) ! Ct_3S1pp
    call chp_set_CIB_LO_contact(1,  0, -0.33879311 ) ! Ct_1S0np
    call chp_set_CIB_LO_contact(2,  0, -0.26456205 ) ! Ct_3S1np
    call chp_set_CIB_LO_contact(1,  1, -0.33052332 ) ! Ct_1S0nn
    call chp_set_CIB_LO_contact(2,  1, -0.26456205 ) ! Ct_3S1nn

    ! NLO contacts
    call chp_set_chiral_C(1) ! Use
    call chp_set_NLO_contact(1, 2.49479227 ) ! C_1S0
    call chp_set_NLO_contact(2, 0.67946029 ) ! C_3P0
    call chp_set_NLO_contact(3, 0.46916903 ) ! C_1P1
    call chp_set_NLO_contact(4, -0.98042368 ) ! C_3P1
    call chp_set_NLO_contact(5, 1.160551 ) ! C_3S1
    call chp_set_NLO_contact(6, 0.30519545 ) ! C_3S1-3D1
    call chp_set_NLO_contact(7, -0.86978982 ) ! C_3P2
