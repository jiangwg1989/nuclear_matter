...
plt.title('A=132 saturation_dens=%.4f  saturation_energy=%.2f\npnm_E/A=%.2f  snm_E/A=%.2f\n\
A=28 saturation_dens=%.4f  saturation_energy=%.2f\npnm_E/A=%.2f  snm_E/A=%.2f\
'% (N_132_saturation_dens,saturation_energy_132,N_132_saturation_pnm,N_132_saturation_snm, N_28_saturation_dens,saturation_energy_28,N_28_saturation_pnm,N_28_saturation_snm ))
